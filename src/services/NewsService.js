...
const fetchOfficialAnnouncements = () => {
    return [
        ...
        {
            title: 'PUDA: Notice and Advertisements for New Schemes 2024',
            link: 'https://puda.gov.in/',
            pubDate: new Date().toISOString(),
            description: 'Official notice regarding upcoming residential and development schemes in Punjab.',
            source: 'PUDA Official',
            isOfficial: true
        }
    ];
};
